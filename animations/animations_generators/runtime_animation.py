        ...
        for car in self.cars:
            ...
            with open(file_path, "w") as file:
                for movement_instruction in car["movement_instructions"]:
                    file.write(
                        f"{movement_instruction['movement_instructions']['speed_instruction'].name} {movement_instruction['movement_instructions']['turn_instruction'].name} {movement_instruction['turn_signals_instruction'].name}\n"
                    )
