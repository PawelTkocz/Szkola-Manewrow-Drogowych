...
class Intersection():
    def __init__(self, id: str, area: Rectangle, lane_width: int):
        self.id = id
        self.lane_width = lane_width
        self.area = area.copy()
        self.intersection_parts = self._calculate_intersection_parts()
        self.drafter = IntersectionDrafter(self.intersection_parts)
        ...
        return {
            ...
            "incoming_lines": {
                ...
                Directions.RIGHT: Rectangle(
                    Point(
                        area_center.x + lane_width, area_center.y - lane_width / 2
                    ),
                    lane_width,
                ...
                Directions.DOWN: Rectangle(
                    Point(
                        area_center.x + lane_width / 2, area_center.y + lane_width
                    ),
                    lane_width,
                    vertical_lanes_length,
                    Direction(Point(0, 1)),
