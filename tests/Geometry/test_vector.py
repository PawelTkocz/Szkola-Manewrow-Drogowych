...
def test_init(vector: Vector, expected: Point) -> None:
    max_rel_tol = 1e-12
...
def test_len(vector: Vector, expected: float) -> None:
    max_rel_tol = 1e-12
...
def test_scale(vector: Vector, k: float, expected: Vector) -> None:
    max_rel_tol = 1e-12
...
def test_scale_to_len(vector: Vector, len: float, expected: Vector) -> None:
    max_rel_tol = 1e-12
...
def test_normalize(vector: Vector, expected: Vector) -> None:
    max_rel_tol = 1e-12
...
def test_rotate_over_point() -> None:
