...
from road_control_center.intersection.intersection_control_center import IntersectionControlCenter
...
class IntersectionA0ControlCenter(IntersectionControlCenter):
    ...
    def get_movement_instructions(self) -> dict[str, MovementInstruction]:
        ...
        live_cars_data = [car_on_intersection["car_data_transmitter"].get_live_car_data() for car_on_intersection in self.cars_data]